...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2016 at 10:12 PM
...
INSERT INTO `cbc` (`Report_ID`, `TID`, `DATE`, `White_Blood_Cell`, `Red_Blood_Cell`, `Hemoglobin`, `Hematocrit`, `Mean_Corpuscular_Volume`, `Mean_Corpuscular_Hb`, `Mean_Corpuscular_Hb_Conc`, `RBC_Distribution_Width`, `Platelet_Count`, `Mean_Platelet_Volume`, `Neutrophils`, `Lymphocytes`, `Monoyte`, `Eosinophil`, `Basophil`, `PID`) VALUES
(1, 3, '2016-08-02', '3.18        X10^9/L', '4.70        X10^12/L', '145.00     g/L', '0.43        Vol.F', '92.10      fL', '30.90      pg', '33.50      %', '12.00      %', '117.00    X10^9/L', '9.70        fL', '54.70      %', '32.10      %', '12.90      %', '0.00        %', '0.30        %', 104),
(2, 4, '2016-08-15', '3.28        X10^9/L', '4.25        X10^12/L', '125.00     g/L', '0.35        Vol.F', '90.10      fL', '32.90      pg', '33.50      %', '13.00      %', '117.00    X10^9/L', '9.80        fL', '54.70      %', '32.10      %', '12.90      %', '0.00        %', '0.50        %', 109);
...
INSERT INTO `lipid_profile` (`PID`, `Report_ID`, `TID`, `DATE`, `LDL_Choloesterol`, `HDL_Choloesterol`, `VLDL_Choloesterol`, `Choloesterol_Total`, `Triglycerides`, `NON_HDL_Chol_LDL_VDL`, `APOB100_Calc`, `LDL_R`, `LP_Cholesterol`) VALUES
(101, 1, 2, '2016-08-01', '185      High      mg/dl      <130', '65                    mg/dl      >=40', '14        High      mg/dl      <30', '265      High      mg/dl      <200', '36                    mg/dl       <150', '199      High      mg/dl       <160', '120      High      mg/dl       <109', '166      High      mg/dl       <109', '15       High      mg/dl       <10'),
(102, 2, 2, '2016-07-01', '150     High     mg/dl     <130', '60                  mg/dl     >=40', '15      High     mg/dl      <30', '225    High     mg/dl     <130', '36                 mg/dl     <150', '192     High     mg/dl     <160', '150     High     mg/dl     <109', '150     High     mg/dl     <100', '12     High     mg/dl      <10'),
(108, 3, 2, '2016-08-12', '140     High     mg/dl     <130', '65                  mg/dl     >=40', '25      High     mg/dl      <30', '230    High     mg/dl     <130', '60                mg/dl     <150', '192     High     mg/dl     <160', '130     High     mg/dl     <109', '150     High     mg/dl     <100', '13     High     mg/dl      <10');
...
--
-- Dumping data for table `liver_function_test`
--

INSERT INTO `liver_function_test` (`PID`, `TID`, `Report_ID`, `DATE`, `Bilirubin_Total`, `Alkaline_Phosphate`, `GGT`, `ALT`, `Albumin`, `Globulin`, `Calcium`, `Phosphorus`) VALUES
(103, 4, 1, '2016-08-03', '0.9', '129', '19', '186', '4.2', '23', 'Nil', 'Nil'),
(106, 4, 3, '2016-08-04', '29', '56', '19', '18', '63', '42', '21', '2.3'),
(110, 4, 2, '2016-08-10', '43', '52', '19', '16', '61', '38', '23', 'Nil');
...
INSERT INTO `stool_test` (`PID`, `Report_ID`, `TID`, `DATE`, `Absent`, `Hymenolepis_nana`, `Giardia_lamblia`, `Entamoeba_coli`, `Endolima_nana`, `Trichocephalus_trichiurus`, `Entamoeba_histolytica`) VALUES
(107, 1, 5, '2016-08-05', '12       50.0%', '5         20.8%', '5        20.8%', '5        20.8%', '2        8.3', '1        4.2', '1        4.2');
...
INSERT INTO `urine_test` (`PID`, `Report_ID`, `TID`, `DATE`, `Volume`, `Color`, `Appearance`, `Specific_Gravity`, `PH`, `Protein`, `Sugar`, `Urobilinogen`, `Urine_Ketone`, `Bile_Salts`, `Bile_Pigments`, `Occult_Blood`, `Pus_Cell`, `Red_Blood_Cell`, `Epithelial_Cell`, `Cast`, `Crystals`, `Others`) VALUES
(101, 1, 1, '2016-08-01', '40 ml', 'Pale Yellow', 'Clear', '1.010', '7.0', 'Absent', 'Absent', 'Normal (<mg/dl)', 'Absent', 'Absent', 'Absent', 'Absent', '1-2/hpf', 'Nil', '1-2/hpf', 'Nil', 'Nil', 'Triple Phosphate(+)'),
(101, 3, 1, '2016-08-05', '40 ml', 'Yellow', 'Clear', '1.110', '7.2', 'Absent', 'Absent', 'Normal (<mg/dl)', 'Absent', 'Positive', 'Absent', 'Absent', '1.5-2/hpf', 'Nil', '1-2.5/hpf', 'Nil', 'Nil', 'Triple Phosphate(+)'),
(105, 2, 1, '2016-08-03', '40 ml', 'Yellow', 'Clear', '1.101', '7.2', 'Absent', 'Absent', 'Normal(<1mg/dl)', 'Absent', 'Absent', 'Negative', 'Negative', '1-1.5/hpf', 'Nil', '1-2/hpf', 'Nil', 'Nil', 'Triple Phosohate(+)'),
(109, 4, 1, '2016-08-15', '40 ml', 'Yellow', 'Clear', '1.101', '7.2', 'Absent', 'Absent', 'Normal(<1mg/dl)', 'Absent', 'Absent', 'Negative', 'Negative', '1-1.5/hpf', 'Nil', '1-2/hpf', 'Nil', 'Nil', 'Triple Phosohate(+)');
